import { IResultCompare, IResultCompareArrayRes, IResultCompareRes } from "../interfaces/resultCompare";

export const formatResultCompareRes = (result: IResultCompare): IResultCompareRes => {
    const res = {
        message: result.message,
        success: result.success,
        model_name: result.model_name,
        results: result.results.map((e): IResultCompareArrayRes => ({
            supplier:e.supplier,
